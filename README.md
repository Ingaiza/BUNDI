...
![BUNDI Dashboard](images/dashboard_1.png)
![BUNDI Dashboard](images/dashboard_2.png)
...
* **Classes:** Detects `Natural` (Birds/Wind), `Unnatural` (Chainsaws/Vehicles), and `Human` (Voices).
...
* **Off-Grid Autonomy:** Solar-powered nodes utilize Deep Sleep cycles, waking only on sound triggers.
